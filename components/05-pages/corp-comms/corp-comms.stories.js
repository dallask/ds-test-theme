...
import euCookieCompliancePopupInfoData
  from '../../03-organisms/block/eu_cookie_compliance_popup_info/eu_cookie_compliance_popup_info.yml';
import modalDataDefault
  from '../../02-molecules/wrapper/modal/modal-data--default.yml';
...
import flexibleHeaderData
  from "../../03-organisms/header/flexible-header.yml";
import paragraphWrapperCardData from "./card-data.yml";
import heroImageData from "../../03-organisms/hero/image-background/hero-image-background.yml";
import carouselData from "./carousel-data.yml";

/**
 * Storybook Definition.
 */
export default {
  title: 'Pages/Corporate Site',
  parameters: {
    layout: 'fullscreen'
  }
};
...
export const aboutPage = () => (
    <div
        dangerouslySetInnerHTML={{
          __html: about({
            ...euCookieCompliancePopupInfoData,
            ...modalDataDefault,
            ...headerBTwigData,
            ...paragraphWrapperCardData,
            ...heroImageData,
            ...carouselData,
            ...
            page: {
              ...
              first_middle_first: contentWithTitle({
                title: 'We defy limitation,<br />so that others can too.',
                content: ''
              }),
