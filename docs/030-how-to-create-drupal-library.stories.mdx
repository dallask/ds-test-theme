<Meta title="Docs/How to create Drupal library"/>
...
The main functionality of this feature is present in the `[theme_name].theme` file
...
It this case you can avoid “attach_library” in the twig template, because
...
- https://docs.emulsify.info/emulsify-drupal/emulsify-drupal/advanced-usage/hot-reload-drupal
